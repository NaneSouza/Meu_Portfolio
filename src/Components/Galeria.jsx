...
function Galeria() {
  ...
  return (
    <S.Fotos2>
      <S.DivProj2>
        <a
          href="https://nanesouza.github.io/cardapio-restaurante/"
          target="_blank"
        >
          <img
            src={Cardapio}
            alt="Imagem da página Inicial do Cardápio de Restaurante"
          />
        </a>
        <h2>
          Site desenvolvido durante o curso Meu primeiro site, promovido pelo
          Projeto Elas na Tech e pela Junior Achievement Brasil e Microsoft.
        </h2>
      ...
      <S.DivProj2>
        <a href="https://nanesouza.github.io/mulheresnaprog2/" target="_blank">
          <img
            src={Mulheres}
            alt="Imagem da página Inicial do Site Mulheres na Programação"
          />
        </a>
        <h2>
          Site desenvolvido durante o curso Meu primeiro site, promovido pelo
      ...
      <S.DivProj2>
        <a
          href="https://nanesouza.github.io/Descod-Tarefa10-Animaheart/"
          target="_blank"
        >
          <img
            src={Animaheart}
            alt="Imagem da página Inicial do site Animaheart"
          />
        </a>
        <h2>
          Site desenvolvido durante o curso promovido pelo Projeto
          Descodificadas.
        </h2>
        <h3>Base do desenvolvimento: HTML e CSS.</h3>
      </S.DivProj2>
      ...
      <S.DivProj2>
        <a href="https://nanesouza.github.io/" target="_blank">
          <img
            src={Portfolio1}
            alt="Imagem da página Inicial do Meu Primeiro Portfólio"
          />
        </a>
        <h2>
          Site desenvolvido como Desafio Final para a conclusão do curso Meu
          primeiro site, promovido pelo Projeto Elas na Tech e pela Junior
          Achievement Brasil e Microsoft.
        </h2>
        <h3>Base do desenvolvimento: HTML e CSS.</h3>
      </S.DivProj2>
      ...
      <S.DivProj2>
        ...
        <h2>
          Site criado como Projeto de conclusão da Trilha 1 do Projeto
          Descodificadas.
        </h2>
        <h3>Base do desenvolvimento: HTML e CSS.</h3>
      </S.DivProj2>
      ...
      <S.DivProj2>
        <a href="https://nanesouza.github.io/LojaPet/" target="_blank">
          <img
            src={LojaPet1}
            alt="Imagem da página Inicial do Site Pet Wedding"
          />
        </a>
      ...
      <S.DivProj2>
        <a href="https://nanesouza.github.io/ProjFinalVnWM1/" target="_blank">
          <img
            src={Fantastika}
            alt="Imagem da página Inicial do Site Fantastika"
          />
        </a>
        <h2>
          Site criado como Projeto de conclusão de Módulo I do Curso Vai na Web.
        </h2>
        <h3>Base do desenvolvimento: HTML e CSS.</h3>
      </S.DivProj2>
      ...
      <S.DivProj2>
        <a href="https://projetoreactlojapet24.vercel.app/" target="_blank">
          <img
            src={Contador}
            alt="Imagem da página Inicial do Site Pets com contador"
          />
        </a>
      ...
      <S.DivProj2>
        <a href="https://projeto-cn-24.vercel.app/" target="_blank">
          <img
            src={CN}
            alt="Imagem da página Inicial do Site Cartoon Network"
          />
        </a>
        <h2>Site criado como Projeto do Curso Vai na Web - Mod II.</h2>
        <h3>Base do desenvolvimento: HTML, CSS, JavaScript, React.</h3>
